...
function fetchDesignationDetails(id) {
    $.ajax({
        ...
        success: function (result) {
            var desi = result.find(d => d.designationId === id);
            if (desi) {
                console.log(desi);
                $("#editModal").modal("show");
                $("#editDesignationId").val(desi.designationId);
                $("#editDesignationname").val(desi.name);
                // Correctly set the department dropdown to match the saved department ID
...
$("#saveEdit").click(function () {
    var obj = {
        DesignationId: $("#editDesignationId").val(),
